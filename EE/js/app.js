...
const _sMonitorUp = new Howl({ src: ['./audio/monitor_up.mp3'], loop: false, autoplay: false });
const _sMonitorDown = new Howl({ src: ['./audio/monitor_down.mp3'], loop: false, autoplay: false });
...
const _iJumpscareDelay = chance.integer({ min: _iEventAudioDelay, max: (_iEventAudioDelay*3) });
...
setTimeout(() => {
	...
	setTimeout(() => _sJumpscare.stop(), 750);
